<template>
    <div>
        <div :class="{ 'bg-accent-500': style == 'success', 'bg-red-700': style == 'danger' }" v-if="show && message">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{ 'bg-accent-600': style == 'success', 'bg-red-600': style == 'danger' }">
                    ...
                    <div class="flex-shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{ 'hover:bg-accent-600 focus:bg-accent-600': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                            aria-label="Dismiss"
