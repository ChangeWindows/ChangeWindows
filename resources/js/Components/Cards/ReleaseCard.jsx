...
export default function ReleaseCard({ name, platform, channels, alts, url }) {
    return (
            ...
            <div className="card release">
                <div className="d-flex flex-row">
                    ...
                    <div className={clsx({ 'ms-2': platform })}>
                        ...
                        {alts && !platform?.tool && <p className="text-muted mb-0 mt-n1"><small>{alts.join(', ')}</small></p>}
                    </div>
                </div>
                ...
                <div className="release-actions">
                    <a href={url} className="btn btn-link btn-sm stretched-link"><FontAwesomeIcon icon={faArrowRight} fixedWidth /> View release</a>
                </div>
            </div>
        </div>
    );
