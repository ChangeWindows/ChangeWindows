  ...
  return (
    <Admin>
      <form onSubmit={handleSubmit}>
        <NaviBar back="/admin/permissions" actions={<SaveButton loading={processing} />}>
        ...
        <div className="container my-3">
          ...
          <Fieldset title="Variants" description="Select which variants of this permission should be created.">
