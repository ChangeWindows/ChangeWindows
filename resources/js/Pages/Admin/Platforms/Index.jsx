      ...
      <NaviBar
        actions={
          can.platforms.create && (
            <Link href={route("admin.platforms.create")} className="btn btn-primary btn-sm">
      ...
      <div className="container">
        ...
        <div className="row g-1">
          {platforms.map((platform) => {
            ...
            return (
              <div className="col-xl-4 col-xxl-3 col-6" key={platform.id}>
                <Link href={route("admin.platforms.edit", platform)} className="card border-0 shadow-sm">
