                                        ...
                                        <div className="col-12 col-lg-6">
                                            <div className="form-check">
                                                ...
                                                <label className="form-check-label" htmlFor="active">
                                                    Active<br />
                                                    <small className="form-text">This platform is still receiving updates.</small>
                                                </label>
                                            </div>
                                        </div>
                                        <div className="col-12 col-lg-6">
                                            <div className="form-check">
                                                ...
                                                <label className="form-check-label" htmlFor="legacy">
                                                    Legacy<br />
                                                    <small className="form-text">This platform has been deprecated or is nearing deprecation.</small>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
